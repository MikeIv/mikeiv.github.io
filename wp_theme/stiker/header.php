...
<head>
  ...
  <meta name="description" content="Заказать этикетки, наклейки, стикеры в типографии в Москве">
  ...
  <link rel="preload" href="img/main-bg.jpg" as="image">
  <link rel="preload" href="fonts/FiraSans-Regular" as="font">
  <link rel="preload" href="fonts/FiraSans-Italic" as="font">
  <link rel="preload" href="fonts/FiraSans-Light" as="font">
  <link rel="preload" href="fonts/FiraSans-Medium" as="font">
  <link rel="preload" href="fonts/FiraSans-Bold" as="font">
  <?php wp_head(); ?>
</head>
...
<p class="browserupgrade">Вы используете <strong>устаревший</strong> браузер. Пожалуйста <a href="https://browsehappy
            .com/">обновите браузер</a> для корректного отображения страниц и для Вашей безопасности.</p>
<![endif]-->

<header class="main-header">
  <nav class="main-nav main-nav--opened main-nav--nojs">
    <button class="main-nav__toggle" type="button"><span class="main-nav__nav-txt">Открыть меню</span></button>
    <ul class="main-nav__top">
      <li class="main-nav__logo-wrapper">
        <a class="main-nav__logo-link">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="90" height="90"><title>Logo SL  invert</title><circle
      ...
      <li class="main-nav__item-desk"><a href="about.html">О компании</a></li>
      <li class="main-nav__item-desk"><a href="production.html">Продукция</a></li>
      <li class="main-nav__item-desk"><a href="manufacture.html">Производство</a></li>
      <li class="main-nav__item-desk"><a href="advantage.html">Преимущества</a></li>
      <li class="main-nav__phone">
        <p class="main-nav__phone-number">+7 (713) 294-15-90</p>
        <p class="main-nav__schedule">Этикетки</p>
        <a class="main-nav__contact" href="contact.html">Контакты</a>
      </li>
    </ul>
    <ul class="main-nav__list">
      <li class="main-nav__item main-nav__item-1"><a href="about.html">О компании</a></li>
      <li class="main-nav__item main-nav__item-2"><a href="production.html">Продукция</a></li>
      <li class="main-nav__item main-nav__item-3"><a href="manufacture.html">Производство</a></li>
      <li class="main-nav__item main-nav__item-4"><a href="advantage.html">Преимущества</a></li>
    </ul>
  </nav>
</header>