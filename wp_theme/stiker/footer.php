<footer class="footer">
  <section class="footer-block">
    <ul class="footer-block__list wrapper">
      <li class="footer-block__item footer-contact">
        <ul class="footer-contact__list">
          ...
          <li class="footer-contact__item">
            <p class="footer-contact__header">Обратный звонок</p>
            <p class="footer-contact__phone">+7 495 532-35-99</p>
          </li>
          <li class="footer-contact__item">
            <p class="footer-contact__header">Почта</p>
            <p class="footer-contact__mail">info@sticker-label.ru</p>
          </li>
        </ul>
      </li>
      <li class="footer-block__item footer-nav">
        <ul class="footer-nav__list">
          <li class="footer-nav__item"><a href="#" class="footer-nav__link">О компании</a></li>
          <li class="footer-nav__item"><a href="#" class="footer-nav__link">Продукция</a></li>
          <li class="footer-nav__item"><a href="#" class="footer-nav__link">Производство</a></li>
          <li class="footer-nav__item"><a href="#" class="footer-nav__link">Преимущества</a></li>
          <li class="footer-nav__item"><a href="#" class="footer-nav__link">Контакты</a></li>
        </ul>
      </li>
      <li class="footer-block__item footer-copyright">
        <p class="footer-copyright__txt">© 2005-2018 Sticker-label</p>
        <p class="footer-copyright__txt">Наклейки, стикеры, изготовление наклеек, печать стикеров</p>
        <p class="footer-copyright__txt">При полном или частичном использовании любых материалов - обязательна ссылка на www.sticker-label.ru</p>
      </li>
    </ul>
  </section>
